  ...
  return (
    <>
      <div className="h-auto md:h-[100vh] lg:h-[100vh] bg-gray-100 text-black py-20">
        <h1 className="prod-1 font-bold text-5xl">What We Offer</h1>
        ...
        <div className="block md:flex lg:flex justify-between w-5/6 mx-auto mt-8">
          <div className="bg-white w-[200px] rounded-xl border-2 border-white hover:border-gray-300 transition-all p-4 my-4 mx-auto">
