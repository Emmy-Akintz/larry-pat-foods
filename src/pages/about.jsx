...
function about() {
  return (
    <>
      <div className="h-[70vh] md:h-[60vh] lg:h-[60vh] about-image text-white">
        <div className="bg-green-500 w-[100%] md:w-[100vh] lg:w-[100vh] float-right h-[70vh] md:h-[60vh] lg:h-[60vh] px-12 py-20 text-left">
